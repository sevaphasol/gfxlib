...
static_assert( offsetof( Vertex, position ) == offsetof( sf::Vertex, position ) );
static_assert( offsetof( Vertex, color ) == offsetof( sf::Vertex, color ) );
static_assert( offsetof( Vertex, tex_coords ) == offsetof( sf::Vertex, texCoords ) );
